...
requestCookies :: HTTP.IncomingMessage HTTP.IMServer -> Map String String
...
requestCookieHeader :: HTTP.IncomingMessage HTTP.IMServer -> Maybe String
requestCookieHeader = IncomingMessage.headers >>> Object.lookup "cookie"
