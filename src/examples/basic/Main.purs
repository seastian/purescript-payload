...
getUsers :: { guards :: { adminUser :: AdminUser, request :: HTTP.IncomingMessage HTTP.IMServer }} -> Aff (Array User)
...
getAdminUser :: HTTP.IncomingMessage HTTP.IMServer -> Aff (Either Failure AdminUser)
getAdminUser req = do
...
parseAuthToken :: HTTP.IncomingMessage HTTP.IMServer -> Aff (Either String String)
